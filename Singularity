...
%environment
	...
	MPICH_DIR=/lib64/mpich
	SINGULARITY_MPICH_DIR=$MPICH_DIR
	SINGULARITYENV_APPEND_PATH=$MPICH_DIR/bin
	SINGULARITYENV_APPEND_LD_LIBRARY=$MPICH_DIR/lib
	export MPICH_DIR SINGULARITY_MPICH_DIR SINGULARITYENV_APPEND_PATH SINGULARITYENV_APPEND_LD_LIBRARY
